...
PRODUCTS = {
    'inbox-magnetic-eyelashes':      {'short_id':'inbox',      'category':'lash',      'group':'Natural',      'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':1, 'length':'10.5mm',                'curl':'45 B+',  'design':'V-weave airy fibre',          'tagline':'The one that looks like nothing — and everything.'},
    ...
    'kickoff-magnetic-eyelashes':    {'short_id':'kickoff',    'category':'lash',      'group':'Natural',      'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':2, 'length':'10-11mm',               'curl':'50 C',   'design':'Korean strand-by-strand',     'tagline':'Fresh air energy. Younger-looking.'},
    'boardroom-magnetic-eyelashes':  {'short_id':'boardroom',  'category':'lash',      'group':'Light makeup', 'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':3, 'length':'10-11mm',               'curl':'50 C',   'design':'Classic soft volume',         'tagline':'The one that never gets it wrong.'},
    ...
    'memo-magnetic-eyelashes-pre-order':{'short_id':'memo',       'category':'lash',      'group':'Light makeup', 'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':3, 'length':'12mm',                  'curl':'50 C',   'design':'7-cluster fairy burst',       'tagline':'Sweet, wide-eyed, unforgettable.'},
    ...
    'twilight-magnetic-eyelashes':   {'short_id':'twilight',   'category':'lash',      'group':'Heavy makeup', 'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':5, 'length':'10-11mm',               'curl':'50 C',   'design':'Volumised natural',           'tagline':'The hour between work and magic.'},
    'nightshift-magnetic-eyelashes': {'short_id':'nightshift', 'category':'lash',      'group':'Heavy makeup', 'eye_buckets':['monolid','double-lid'],                   'drama':5, 'length':'10-12mm + 13mm outer',  'curl':'50 C',   'design':'Fox-eye upswept',             'tagline':'Mysterious. Fatal. Irresistible.'},
    'vip-access-magnetic-eyelashes-pre-order':{'short_id':'vip',        'category':'lash',      'group':'Heavy makeup', 'eye_buckets':['monolid','double-lid','inner-double-lid'], 'drama':5, 'length':'11-12mm',               'curl':'50 C',   'design':'Statement volume',            'tagline':'You were born for the front row.'},
